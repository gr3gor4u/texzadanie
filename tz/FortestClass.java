...
public class FortestClass {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Животных травоядных или плотоядных, маленьких: " + (countAnimalsMatchingRule(arrayRost[0],arrayType[1])+countAnimalsMatchingRule(arrayRost[0],arrayType[0])));

        System.out.println("Животных всеядных, не высоких: " + (countAnimalsMatchingRule(arrayRost[0],arrayType[2])+countAnimalsMatchingRule(arrayRost[1],arrayType[2])));
    }
